...
export const FooterLayout = () => {
  return (
    <footer className="bg-[var(--color-bg-secondary)] border-t border-[var(--color-border)] pt-12 md:pt-20 pb-10 px-4 md:px-8">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-2">
            {['Services', 'About', 'Careers', 'News', 'Contact'].map(link => (
