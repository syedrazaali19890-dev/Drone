...
export const HeroSection = () => {
  ...
  return (
    <section ref={containerRef} className="relative h-[100svh] w-full flex items-center justify-start overflow-hidden bg-black">
      ...
      <div className="relative z-20 px-6 md:px-16 lg:px-32 w-full mt-10 md:mt-0">
        <div className="max-w-4xl flex flex-col items-start">
          ...
          <div ref={ctaRef} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-6 w-full sm:w-auto">
            ...
            <Button variant="secondary" size="lg" className="rounded-none border border-white/20 bg-transparent text-white hover:border-white uppercase tracking-widest font-bold text-sm px-10 py-5 transition-all duration-300">
              Contact Us
            </Button>
          </div>
        </div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5, duration: 1 }} className="absolute bottom-10 left-6 md:left-16 z-20 flex flex-col items-start">
